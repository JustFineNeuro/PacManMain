...
def dataloader_EMU(folder='/Users/user/PycharmProjects/PacManMain/data/HumanEMU',subj='YEJ'):
    ...
    #TODO: need to check paused variable and delete those trials (np.isnan)
    #TODO: check brain area listing of neuron
    #TODO: rename 'reward_val' to 'outcome'
...
def rewardalign(df_list):
    '''
    TODO: I really use this for resorting before models and maybe should be there
    :param df_list:
    :return:
    '''
